...
vim.keymap.set({ "n", "x", "o" }, "]]", function()
	require("nvim-treesitter-textobjects.move").goto_next({ "@block.outer", "@call.outer" }, "textobjects")
end)
vim.keymap.set({ "n", "x", "o" }, "[[", function()
	require("nvim-treesitter-textobjects.move").goto_previous({ "@block.outer", "@call.outer" }, "textobjects")
end)
vim.keymap.set({ "n", "x", "o" }, "<M-]>", function()
	require("nvim-treesitter-textobjects.move").goto_next_start({ "@block.outer", "@call.outer" }, "textobjects")
end)
vim.keymap.set({ "n", "x", "o" }, "<M-[>", function()
	require("nvim-treesitter-textobjects.move").goto_previous_start({ "@block.outer", "@call.outer" }, "textobjects")
end)
